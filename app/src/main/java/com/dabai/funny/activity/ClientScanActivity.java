...
public class ClientScanActivity extends AppCompatActivity implements CameraScanner.CameraListener, TextureView.SurfaceTextureListener, GraphicDecoder.DecodeListener, View.OnClickListener {
...
//        mCameraScanner.setFrameRect(mScannerFrameView.getLeft(), mScannerFrameView.getTop(), mScannerFrameView.getRight(), mScannerFrameView.getBottom());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_flash: {
                if (v.isSelected()) {
                    ((ImageButton) v).setImageDrawable(getDrawable(R.drawable.ic_flash_on_black_50dp2));
                    v.setSelected(false);
                    mCameraScanner.closeFlash();
                } else {
                    ((ImageButton) v).setImageDrawable(getDrawable(R.drawable.ic_flash_off_black_50dp2));
                    v.setSelected(true);
